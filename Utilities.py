...
def compare_eigenvalue_distribution(correlation_matrix, Q, sigma=1, set_autoscale=True, show_top=True, make_plots=True):
    ...
    if make_plots:
        ...
        if not show_top:
            ...
            e = e[e <= x_max + 1]
        plt.hist(e, density=True, bins=60, alpha=0.8)  # Histogram the eigenvalues
        ...
        plt.savefig("Eigenvalue_distribution_Equities")
        plt.show()